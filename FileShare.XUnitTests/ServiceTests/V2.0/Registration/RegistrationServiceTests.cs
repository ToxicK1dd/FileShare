...
namespace FileShare.XUnitTests.ServiceTests.V2._0.Registration
{
    public class RegistrationServiceTests
    {
        ...
        public async Task Register_Should_Return_Guids_When_User_Is_Registered()
        {
            ...
            // Act
            var (loginId, accountId) = await _registrationService.RegisterAsync("Test", "test@test.test", "!Test1234", CancellationToken.None);
        ...
        public async Task Register_Should_Throw_When_Username_Is_Taken()
        {
            ...
            // Act
            var ex = await Assert.ThrowsAsync<ArgumentException>(
                () => _registrationService.RegisterAsync(It.IsAny<string>(), "test@test.test", It.IsAny<string>(), CancellationToken.None));
