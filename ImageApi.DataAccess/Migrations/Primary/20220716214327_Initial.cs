        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContactDetail_Account_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Account",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PersonalDetail_Account_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Account",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactDetail_AccountId",
                table: "ContactDetail",
                column: "AccountId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ContactDetail_Email",
                table: "ContactDetail",
                column: "Email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ContactDetail_Id",
                table: "ContactDetail",
                column: "Id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ContactDetail_PhoneNumber",
                table: "ContactDetail",
                column: "PhoneNumber",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonalDetail_AccountId",
                table: "PersonalDetail",
                column: "AccountId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PersonalDetail_Id",
                table: "PersonalDetail",
                column: "Id",
                unique: true);
